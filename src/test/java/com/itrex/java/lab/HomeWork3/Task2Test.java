...
class Task2Test {
    ...
    void createBadWordsDetectingStreamTest() {
        assertLinesMatch(
                Task2.createBadWordsDetectingStream(text, badWord).collect(Collectors.toList()),
                Stream.of("111", "She", "felt", "time").collect(Collectors.toList()) );
    }

    @Test
    void createBadWordsDetectingStreamNullTextTest() {
        assertLinesMatch(
                Task2.createBadWordsDetectingStream(null, badWord).collect(Collectors.toList()),
                List.of());
    }
    ...
    void createBadWordsDetectingStreamNullBadWordsTest() {
        assertLinesMatch(
                Task2.createBadWordsDetectingStream(text,null).collect(Collectors.toList()),
                List.of());
    }
    ...
    void createBadWordsDetectingStreamNullAllTest() {
        assertLinesMatch(
                Task2.createBadWordsDetectingStream(null,null).collect(Collectors.toList()),
                List.of());
    }
    ...
    void createBadWordsDetectingStreamNoMatchesTest(){
        assertLinesMatch(
                Task2.createBadWordsDetectingStream(text,List.of("мама", "мыла","раму")).collect(Collectors.toList()),
                List.of());
    }
